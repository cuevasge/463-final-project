...
plot(sqrt_ocean, which = 4)  
plot(sqrt_ocean, which = 6)  
```
...
```{r}
# Null model (only intercept)
null_model <- lm(sqrt(species) ~ 1, data = GBR_dat)
